...
function CameraRig({
    ...
    useFrame((state, delta) => {
        ...
        // Gentle orbit around the container, biased so it never goes fully
        // behind (stays a front-facing cinematic sweep).
        const radius = 6.6;
        const swing = 0.55; // radians of total sweep either side of center
    ...
    return (
        ...
        >
            ...
            <group position={[0, -0.25, 0]}>
                <ShippingContainer/>
                <ShipmentRoute reducedMotion={reducedMotion} boosted={success} />
