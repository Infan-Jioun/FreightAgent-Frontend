                            ...
                            <div className="pt-3 border-t border-[#1a4a4a]/60 flex items-center justify-between text-xs">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="text-xs font-semibold text-[#7ecfc4] hover:text-[#e0faf5] transition-colors"
                                    >
                                        Details
                                    </button>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-[#1a4a4a]">
                            {canUpdateStatus && (
                                <button
                                    ...
                                    className="px-3.5 py-2 rounded-xl bg-[#00b4d8]/15 hover:bg-[#00b4d8]/25 text-[#00b4d8] border border-[#00b4d8]/30 text-xs font-bold transition-colors"
                                >
