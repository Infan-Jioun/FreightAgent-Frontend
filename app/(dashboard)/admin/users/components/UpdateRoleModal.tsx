...
export default function UpdateRoleModal({
    ...
    onClose,
    onSaveRole,
}: UpdateRoleModalProps): React.JSX.Element | null {
    ...
    return (
        <Modal
            ...
            onClose={onClose}
            maxWidth="md"
            icon={<Shield size={20} className="text-[#f59e0b]" />}
        ...
        >
            <div className="space-y-4">
                {isSelf ? (
                    <div className="p-3.5 rounded-2xl bg-[#e11d48]/10 border border-[#e11d48]/30 flex items-start gap-2.5 text-xs text-[#f43f5e]">
                ...
                {selectedRole === "AGENT" && (
                    <div className="p-4 rounded-2xl bg-[#0a1a1a] border border-[#00c9a7]/40 space-y-2">
